<div class="row">
	<div class="col-lg-12">
		<?php echo form_open("administrator/account_edit_submit/$id", array("class" => "form-horizontal", "id" => "userform")); ?>
			...
			<div class="form-group">
				<label for="expired" class="col-lg-2 control-label">Expired Date :</label>
				<div class="col-lg-6">
					<input type="date" id="expired" name="expired" class="form-control" value="<?php echo $expired_date;?>">
				</div>
			</div>
			<div class="form-group">
