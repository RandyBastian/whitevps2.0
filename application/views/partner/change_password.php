<div class="row">
	<div class="col-lg-12">
		<?php echo form_open("partner/profile/change-password-submit", array("class" => "form-horizontal", "id" => "userform")); ?>
			...
			<div class="form-group">
				<div class="col-lg-6 col-lg-offset-3">
					<input class="btn btn-primary btn-lg btn-block" type="submit" name="submit" id="submit" value="Change My Password">
				</div>
			</div>
		</form>
	</div>
