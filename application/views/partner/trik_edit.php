<div class="row">
	<div class="col-lg-12">
		<?php echo form_open("partner/trik/trik_edit_submit/$id", array("class" => "form-horizontal", "id" => "userform")); ?>
			<div class="form-group">
				<label for="judul" class="col-lg-2 control-label">Judul</label>
				<div class="col-lg-9">
					<input type="text" id="judul" name="judul" class="form-control" value="<?php echo $judul; ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-2">
					<input class="btn btn-primary btn-lg btn-block" type="submit" name="submit" id="submit" value="Update Trik & Tools">
				</div>
			</div>
		</form>
	</div>
